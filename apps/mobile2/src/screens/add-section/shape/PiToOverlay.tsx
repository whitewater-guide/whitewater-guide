...
interface Positions {
  vert: { top: number; left: number; height: number; width: number };
  hor: { top: number; left: number; height: number; width: number };
...
function PiToOverlay({ selected, moving }: Props) {
...
export default memo(PiToOverlay);
