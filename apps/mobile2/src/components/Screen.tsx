...
const NO_TOP_EDGES: Edge[] = ['left', 'right', 'bottom'];
const NO_BOTTOM_EDGES: Edge[] = ['left', 'right', 'top'];
...
function Screen(props: PropsWithChildren<ScreenProps>) {
  ...
  let safeProps: { edges?: Edge[] } | undefined;
  if (safeBottom && !safeTop) {
    safeProps = { edges: NO_TOP_EDGES };
  } else if (!safeBottom && safeTop) {
    safeProps = { edges: NO_BOTTOM_EDGES };
  }
