...
const TRACK_BACKGROUND_COLOR = '#9E9E9E';
...
const RangeSlider = memo<RangeSliderProps>(
  (props) => {
    ...
    const trackSelectedColor = theme.primary;
    const {
      range,
      step,
      behavior = 'continue',
    ...
    const onMove = (_thumb: Thumb, e: GestureResponderEvent) => {
        ...
        <View ref={trackRef} collapsable={false} style={styles.track}>
          <Animated.View
            style={{
              ...
              backgroundColor: inverted.interpolate({
                inputRange: [0, 1],
                outputRange: [TRACK_BACKGROUND_COLOR, trackSelectedColor],
                extrapolate: 'clamp',
              }),
            }}
          />
          <Animated.View
            style={{
              ...
              backgroundColor: inverted.interpolate({
                inputRange: [0, 1],
                outputRange: [trackSelectedColor, TRACK_BACKGROUND_COLOR],
                extrapolate: 'clamp',
              }),
            }}
          />
