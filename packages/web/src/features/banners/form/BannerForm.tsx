...
import { Checkbox, ChipInput, Form, Select, TextInput } from '../../../components/forms';
  ...
  render() {
    ...
    return (
      <Form {...this.props} resourceType="banner">
        <div style={{ padding: 8, height: '100%', overflowX: 'hidden', overflowY: 'scroll'}}>
          <TextInput fullWidth name="slug" title="Slug" disabled={!!initialValues.id} />
          <TextInput fullWidth name="name" title="Name" />
          <TextInput fullWidth name="priority" type="number" title="Priority" />
          <Select simple name="placement" title="Placement" options={PLACEMENTS} />
          <BannerSourceFields
            title="Banner source"
            bucket="banners"
            height={[450, 683]}
