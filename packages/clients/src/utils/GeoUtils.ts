import { Coordinate, Coordinate2d } from '@whitewater-guide/commons';
...
export function gmapsToArray(
  latLng?: LatLng | LatLngLiteral | null,
): Coordinate2d | null {
  if (!latLng) {
    return null;
  }
...
export function arrayToDMSString(
