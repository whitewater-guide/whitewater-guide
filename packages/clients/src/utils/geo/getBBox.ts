 ...
 */
export function getBBox(bounds: Coordinate[], flat?: false): BBox;
export function getBBox(bounds: Coordinate[], flat?: true): BBoxFlat;
export function getBBox(bounds: Coordinate[], flat = false): BBox | BBoxFlat {
