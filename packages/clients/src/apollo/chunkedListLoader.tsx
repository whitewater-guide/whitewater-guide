import { ListType } from '@whitewater-guide/commons';
import React from 'react';
import { WithList } from './types';

type ChunkedListProps<T extends ListType> = { [propName in T]: WithList<any> };
...
export const chunkedListLoader = <T extends ListType>(propName: T) => (
  ...
  return class SectionsBatchLoader extends React.PureComponent<
    ChunkedListProps<T>
  > {
    componentDidMount() {
