...
storiesOf('Premium dialog: auth step', module)
  ...
  .add('Without user', () => <AuthStep cancelable={false} me={null} />)
  .add('Without user, cancelable', () => <AuthStep me={null} />)
  .add('With user', () => <AuthStep cancelable={false} me={user} />)
  .add('With user, cancelable', () => <AuthStep me={user} />);
