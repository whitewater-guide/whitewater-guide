...
- Возможность скачать данные для работы в оффлайне
    `,
  },
  alreadyHave: {
  ...
  errors: {
    refreshPremium:
      'Ошибка, кажется такого товара нет. Пожалуйста, проверьте интернет соединение.',
    fetchProduct:
      'Ошибка, мы не смогли определить цену покупки. Пожалуйста, проверьте интернет соединение.',
    buyProduct: 'Ошибка покупки. Пожалуйста, проверьте интернет соединение.',
    savePurchase:
      'Ошибка сохранения покупки. Свяжитесь с нами. Номер вашей транзакции {{transactionId}}.',
    savePurchaseOffline:
      'Ошибка сохранения покупки. Пожалуйста, проверьте интернет соединение. Номер вашей транзакции {{transactionId}}.',
    alreadyOwned:
      'Похоже вы уже купили этот регион. Пожалуйста, выйдите и зайдите под тем аккаунтом, который вы использовали для покупки. Номер вашей транзакции {{transactionId}}.',
  },
  section: {
    message:
      '{{region}} - это премиум регион. Описания сплавных участков доступны только после покупки',
