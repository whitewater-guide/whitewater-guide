...
- Точные координаты всех точек в удобном формате
  ...
  errors: {
    ...
    alreadyOwned: 'Похоже вы уже купили этот регион. Пожалуйста, выйдите и зайдите под тем аккаунтом, который вы использовали для покупки. Номер вашей транзакции {{transactionId}}.',
  },
  section: {
