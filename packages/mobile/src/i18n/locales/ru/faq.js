...
Мы считаем, что для каждой секции очень важно давать информацию по уровням воды. Мы используем простые термины: "мин", "опт" и "макс" для описания низкого уровня воды, оптимального и высокого соответственно. Обычно сплавной участок теряет привлекательность, а может быть даже становится непроходим, если в реке уровень воды ниже "мин". "Опт" - это не средний уровень, а тот уровень, по которому мы рекомендуем сплавляться по данному участку, и при котором сложность наиболее соответствует указанной. "Макс", или высокий уровень, это предел, до которого сохраняется указанная в описании сложность. Часто река остается сплавной и при уровне воды, большем отметки "макс", но у него возрастает категория сложности. Кроме того, мы используем бардовый цвет для обозначения реального максимума, то есть отметки, выше которой по реке сплавляться нельзя.
Обратите внимания, что все эти отметки и цвета не имеют отношения к историческим минимумам и максимумам!
...
All sections on a region’s map are shown as colored arrows. C
