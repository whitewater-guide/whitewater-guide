...
beforeEach(async () => {
  ...
  await element(by.id('region-tab-list')).atIndex(0).tap();
...
it('should navigate between tabs', async () => {
  ...
  // media
  await element(by.id('section-tab-media')).atIndex(0).tap();
  await expect(element(by.id('header-back')).atIndex(0)).toBeVisible();
  ...
  await element(by.id('section-tab-chart')).atIndex(0).tap();
