...
import { SOURCE_ALPS, SOURCE_GALICIA_1, SOURCE_GALICIA_2, SOURCE_GEORGIA, SOURCE_NORWAY } from '@seeds/05_sources';
import { GAUGE_GAL_2_1, GAUGE_GEO_3, GAUGE_NOR_1, GAUGE_NOR_3, GAUGE_NOR_4 } from '@seeds/06_gauges';
