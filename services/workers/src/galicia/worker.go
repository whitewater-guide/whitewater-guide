...
func (w *workerGalicia) Autofill(options map[string]interface{}) ([]core.GaugeInfo, error) {
	resp, err := core.Client.Get("http://servizos.meteogalicia.es/rss/observacion/jsonAforos.action")
	if err != nil {
		return nil, err
	}
