...
type FieldArrayProps = BaseFieldArrayProps<POICollectionProps> &
  POICollectionProps;

const CustomField = FieldArray as new () => GenericFieldArray<
  Partial<Point>,
  POICollectionProps
>;

export const POICollection: React.StatelessComponent<
  Omit<FieldArrayProps, 'component'>
> = (props) => {
  return <CustomField {...props} component={POICollectionComponent as any} />;
};
