...
export const RatingComponent: React.StatelessComponent<Props> = ({
  input,
  meta,
  title,
}) => (
  <div style={styles.wrapper}>
    <span>{title}</span>
    <RatingRaw value={input!.value} onChange={input!.onChange} />
  </div>
);
...
export const RatingInput: React.StatelessComponent<FieldProps> = (props) => {
  return <CustomField {...props} component={RatingComponent as any} />;
};
