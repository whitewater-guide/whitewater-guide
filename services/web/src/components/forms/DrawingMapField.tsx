...
const FieldComponent: React.StatelessComponent<Props> = ({
  input,
  meta,
  ...props
}) => (
...
export const DrawingMapField: React.StatelessComponent<FieldProps> = ({
  ...props
}) => {
  const CustomField = Field as new () => GenericField<CustomFieldProps>;
  return <CustomField {...props} component={FieldComponent} />;
};
